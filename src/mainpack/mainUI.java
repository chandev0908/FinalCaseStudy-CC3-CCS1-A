...
public class mainUI {
	...
	public void initialize() {
		...
		lblNewLabel_5_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					for (int isddw = 0; isddw <= fName.size(); isddw++) {
						tableModel.removeRow(0);
						fName.remove(0);
						studentID.remove(0);
						email.remove(0);
						permitCode.remove(0);
						permitAvailability.remove(0);
						course.remove(0);
						phoneNum.remove(0);
						filepath.remove(0);
					}
